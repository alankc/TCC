...
${OBJECTDIR}/Auxiliar/MapResizer.o: Auxiliar/MapResizer.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/local/include/player-3.0 -I/usr/include/cppconn -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Auxiliar/MapResizer.o Auxiliar/MapResizer.cpp

${OBJECTDIR}/DataBase/DaoGeneral.o: DataBase/DaoGeneral.cpp
	${MKDIR} -p ${OBJECTDIR}/DataBase
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/local/include/player-3.0 -I/usr/include/cppconn -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DataBase/DaoGeneral.o DataBase/DaoGeneral.cpp

${OBJECTDIR}/DataBase/DaoTask.o: DataBase/DaoTask.cpp
	${MKDIR} -p ${OBJECTDIR}/DataBase
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/local/include/player-3.0 -I/usr/include/cppconn -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DataBase/DaoTask.o DataBase/DaoTask.cpp

${OBJECTDIR}/PathPlanning/DStartLite.o: PathPlanning/DStartLite.cpp
	${MKDIR} -p ${OBJECTDIR}/PathPlanning
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/local/include/player-3.0 -I/usr/include/cppconn -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/PathPlanning/DStartLite.o PathPlanning/DStartLite.cpp

${OBJECTDIR}/PathPlanning/PriorityQueue.o: PathPlanning/PriorityQueue.cpp
	${MKDIR} -p ${OBJECTDIR}/PathPlanning
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/local/include/player-3.0 -I/usr/include/cppconn -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/PathPlanning/PriorityQueue.o PathPlanning/PriorityQueue.cpp

${OBJECTDIR}/TasksPlanning/TaskPlanner.o: TasksPlanning/TaskPlanner.cpp
	${MKDIR} -p ${OBJECTDIR}/TasksPlanning
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/local/include/player-3.0 -I/usr/include/cppconn -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TasksPlanning/TaskPlanner.o TasksPlanning/TaskPlanner.cpp

${OBJECTDIR}/main.o: main.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/local/include/player-3.0 -I/usr/include/cppconn -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/main.o main.cpp
